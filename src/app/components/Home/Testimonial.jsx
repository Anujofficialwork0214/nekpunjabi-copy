...
const demo = () => {
  return (
    <div className="min-h-screen bg-white p-6 flex flex-col items-center justify-center space-y-12">
      {testimonials.map((t, index) => (
        <motion.div
          ...
          className="max-w-3xl bg-white p-6 shadow-md rounded-lg w-full"
        >
