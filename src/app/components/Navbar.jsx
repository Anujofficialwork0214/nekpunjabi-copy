...
const Navbar = () => {
  ...
  return (
    <header className="fixed top-0 left-0 w-full px-6 py-8 backdrop-blur-lg bg-white/30  shadow-md z-50 font-poppins rounded-b-3xl">
      ...
      {/* Mobile Menu */}
      <div
        className={`fixed top-0 right-0 h-screen w-2/3 sm:w-2/5 shadow-lg p-6 transition-transform duration-500 z-50 ${
